      ...
      >
        ...
        <div className="mt-3 flex items-center justify-between">
          ...
          <button
            ...
            onClick={onClose}
            aria-label="Close"
            className="ml-auto flex h-11 w-11 items-center justify-center rounded-full text-foreground/40 transition-colors duration-150 hover:bg-surface-secondary hover:text-foreground/70 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/30 focus-visible:ring-offset-2 focus-visible:ring-offset-paper"
          >
