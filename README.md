...
**A personal wallet and peer payments.** Every member also gets a personal Uzuza wallet. Top up or withdraw via MTN MoMo, see a running transaction history with CSV export for your own records, and send or request money directly from another Uzuza user by phone number or email, with the same proof-of-transfer discipline used everywhere else in the app.
